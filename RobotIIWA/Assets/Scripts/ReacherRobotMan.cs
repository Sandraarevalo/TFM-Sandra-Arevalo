...
public class ReacherRobotMan : Agent
{
    ...
    public override void Initialize()
    {
        ...
        m_RbM = pendulumM.GetComponent<Rigidbody>();
    ...
    public override void OnEpisodeBegin()
    {
        ...
        pendulumM.transform.position = new Vector3(0f, 0f, 0f) + transform.position;
        pendulumM.transform.rotation = Quaternion.Euler(0f, 0f, 0f);
        m_RbM.velocity = Vector3.zero;
        m_RbM.angularVelocity = Vector3.zero;
    ...
    {
        m_GoalRadius = Random.Range(0.5f, 0.5f);
        m_GoalDegree = Random.Range(0f, 360f);
        m_GoalSpeed = Random.Range(0.1f, 0.1f); //-2,2
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(pendulumM.transform.localPosition);
        sensor.AddObservation(pendulumM.transform.rotation);
        sensor.AddObservation(m_RbM.angularVelocity);
        sensor.AddObservation(m_RbM.velocity);
